...
**1. Behavior changes ship with tests in the same commit.** This is a hard-learned rule: a `check-plan.py` regex fix once broke a fixture silently because the change had no test. Any edit to a script's behavior updates or adds cases in its `test_*.py`. Run `python3 -m pytest scripts/ hooks/ -q` — it must stay green (currently **142** passing (+1 skipped until a plan-mode reference exists): 25 check_plan + 39 check_redstate + 38 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 25 check_plan + 37 check_redstate + 38 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 25 check_plan + 41 check_redstate + 38 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 25 check_plan + 41 check_redstate + 38 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 25 check_plan + 41 check_redstate + 34 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 25 check_plan + 40 check_redstate + 34 check_spec_surface + 14 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 23 check_plan + 38 check_redstate + 33 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 23 check_plan + 38 check_redstate + 33 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 23 check_plan + 37 check_redstate + 31 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 23 check_plan + 37 check_redstate + 28 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 22 check_plan + 36 check_redstate + 26 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 22 check_plan + 35 check_redstate + 26 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 22 check_plan + 32 check_redstate + 24 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 22 check_plan + 32 check_redstate + 22 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`): 22 check_plan + 32 check_redstate + 21 check_spec_surface + 12 gen_authz_matrix + 26 spec_edit_guard — count with pytest, not by grepping `def test_`).
